    ...
    <style>
        *{
        ...
        .card{
            ...
            overflow: hidden;
            border-radius: 10px;
            background-image: url('assets/backgroundregister.jpg'); /* Replace with your background image */
                    ...
                    <div class="card-body">
                        <form action="{{ route('registerpost') }}" method="post" class="mt-5">
                            ...
                            <div class="input-text">
                                ...
                                <a href="{{route('login')}}" class="btn btn-primary mt-2 border-2 text-black">User Login</a>
