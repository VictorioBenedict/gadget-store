...
<body>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col md-6">
                <div class="title text-center" style="color: #131842";><h3>Add Device</h3></div>
                <form method="POST" action="{{ route ('store') }}" class="p-4 border border-2 border-black mt-5 fw-bold" enctype="multipart/form-data">
                    @csrf
